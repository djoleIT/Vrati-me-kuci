...
export async function GET(req, { params }) {
  ...
  // Uzmi ISKLJUČIVO crne path-ove QR koda — nema pozadinskog pravougaonika,
  // okvira niti ijednog <rect> elementa, čak i ako ga biblioteka doda sama.
  ...
  <g transform="translate(${padding}, ${padding})">${darkPaths}</g>
