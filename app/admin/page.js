        ...
        <table className="ordertable">
          <thead>
            <tr>
              ...
              <th>Napomene</th><th>Tip</th><th>Cena / Pouzeće</th><th>Status</th><th>QR</th>
            </tr>
          </thead>
          <tbody>
            {orders?.map((o) => {
              ...
              return (
                <tr key={o.id}>
                  ...
                  <td>
                    <strong>{o.price} din</strong> <span style={{ opacity: 0.5, fontSize: 11 }}>(privezak)</span><br />
                    <span style={{ fontSize: 11, opacity: 0.5 }}>+ {o.shipping} din dostava = {o.total} din pouzeće</span>
                  </td>
                  ...
                  <td>
                    ...
                    <CopyButton
                      text={[
                        ...
                        `Ukupno za pouzeće: ${o.total} din (privezak ${o.price} din + dostava ${o.shipping} din)`,
                      ].filter(Boolean).join("\n")}
                    />
                  </td>
                </tr>
