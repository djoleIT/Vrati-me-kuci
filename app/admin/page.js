        ...
        <table className="ordertable">
          <thead>
            <tr>
              ...
              <th>Napomene</th><th>Pričvršćivanje/Prikaz</th><th>Cena</th><th>Skeniranja</th><th>Status</th><th>QR</th>
            </tr>
          </thead>
          <tbody>
            {orders?.map((o) => {
              ...
              return (
                <tr key={o.id}>
                  ...
                  <td>
                    {o.attachment_type === "strap" ? "Traka za navlačenje" : "Alkica"}<br />
                    <span style={{ fontSize: 11, opacity: 0.6 }}>
                      {o.show_name_on_tag === false ? "Samo QR" : "Sa imenom"}
                    </span>
                  </td>
                  <td>{o.price} din</td>
                  <td>
                  ...
                  <td>
                    ...
                    <CopyButton
                      text={[
                        ...
                        `Pričvršćivanje: ${o.attachment_type === "strap" ? "Traka za navlačenje" : "Alkica"}`,
                        `Prikaz: ${o.show_name_on_tag === false ? "Samo QR" : "Sa imenom"}`,
                        `Cena: ${o.price} din`,
                      ].filter(Boolean).join("\n")}
                    />
                  </td>
