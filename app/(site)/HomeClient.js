      ...
      <div className="hero">
        ...
        <div className="tagcard tagcardlive">
          ...
          <div className="tag">
            ...
            <div className="qrbox">
              {demoUrl ? <img src={qrPngUrl(demoUrl, 220)} alt="Probni QR kod" /> : <div style={{ width: "100%", paddingTop: "100%" }} />}
            </div>
            <div className="url">{demoUrl ? demoUrl.replace(/^https?:\/\//, "") : "..."}</div>
          </div>
          {demoUrl && (
            <a href={demoUrl} target="_blank" rel="noreferrer" className="tryqrbtn">
              📱 Isprobaj ga — skeniraj ili klikni
            </a>
          )}
