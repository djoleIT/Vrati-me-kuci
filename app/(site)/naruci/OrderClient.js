...
import { REGULAR_PRICE, PROMO_PRICE, CONTACT_EMAIL } from "@/lib/config";
...
const empty = {
  ...
  deliveryPhone: "", showAddressPublic: false,
  pageMode: "contact",
  attachmentType: "ring",
  showNameOnTag: true,
};
    ...
    <div>
      ...
      <div className="panel">
        ...
        <div className="tagoptions">
          ...
          >
            <TagIcon variant="ring" showName={form.showNameOnTag} />
          ...
          >
            <TagIcon variant="strap" showName={form.showNameOnTag} />
        ...
        <div className="tagoptions">
          ...
          >
            <TagIcon variant={form.attachmentType} showName />
          ...
          >
            <TagIcon variant={form.attachmentType} showName={false} />
        ...
        <p className="ordernote">
          {t.orderNote} <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>
        </p>
      </div>
    </div>
  );
