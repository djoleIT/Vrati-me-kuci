  ...
  sr: {
    ...
    trustFacts: [
      ...
      { title: "Udoban za ljubimca", text: "Privezak stoji u visini ogrlice, dizajniran tako da ga pas ne može zvakati." },
          { title: "Garancija besplatne zamene", text: "Ako QR kod ikad prestane da radi, šaljemo ti zamenu potpuno besplatno." },
    ],
    ...
    "sections": [
        ...
        {
            "title": "Garancija",
            "body": "Ako QR kod na tvom privezku ikad prestane da radi, ili privezak fizički otkaže usled greške u izradi, besplatno ti šaljemo zamenu. Javi nam se na kontakt ispod sa opisom problema."
        },
        {
  ...
  en: {
    ...
    trustFacts: [
      ...
      { title: "Comfortable for your pet", text: "The tag sits at collar height, designed so your dog can't chew on it." },
          { title: "Free replacement guarantee", text: "If the QR code ever stops working, we send you a replacement completely free." },
    ],
    ...
    "sections": [
        ...
        {
            "title": "Warranty",
            "body": "If the QR code on your tag ever stops working, or the tag physically fails due to a manufacturing defect, we'll send you a free replacement. Contact us below with a description of the issue."
        },
        {
  ...
  ru: {
    ...
    trustFacts: [
      ...
      { title: "Удобно для питомца", text: "Брелок расположен на уровне ошейника, питомец не может его жевать." },
          { title: "Гарантия бесплатной замены", text: "Если QR-код когда-либо перестанет работать, мы бесплатно вышлем замену." },
    ],
    ...
    "sections": [
        ...
        {
            "title": "Гарантия",
            "body": "Если QR-код на вашем брелоке перестанет работать, или брелок физически выйдет из строя из-за производственного дефекта, мы бесплатно вышлем замену. Свяжитесь с нами по контакту ниже с описанием проблемы."
        },
        {
  ...
  zh: {
    ...
    trustFacts: [
      ...
      { title: "宠物佩戴舒适", text: "挂牌贴合项圈高度佩戴,设计上狗狗无法啃咬。" },
          { title: "免费更换保修", text: "如果二维码失效,我们将完全免费为您更换。" },
    ],
    tagStandard: "标准挂牌",
    ...
    "sections": [
        ...
        {
            "title": "保修",
            "body": "如果您挂牌上的二维码失效,或挂牌因制造缺陷而物理损坏,我们将免费为您更换。请通过下方联系方式告知问题详情。"
        },
        {
            "title": "个性化定制与撤销权",
  ...
  de: {
    ...
    trustFacts: [
      ...
      { title: "Angenehm für dein Haustier", text: "Die Marke sitzt auf Halsbandhöhe, so konzipiert, dass dein Hund nicht daran kauen kann." },
          { title: "Kostenlose Ersatzgarantie", text: "Sollte der QR-Code jemals nicht mehr funktionieren, senden wir dir kostenlos einen Ersatz." },
    ],
    ...
    "sections": [
        ...
        {
            "title": "Garantie",
            "body": "Sollte der QR-Code auf deiner Marke jemals nicht mehr funktionieren oder die Marke aufgrund eines Herstellungsfehlers physisch versagen, senden wir dir kostenlos einen Ersatz. Kontaktiere uns unten mit einer Beschreibung des Problems."
        },
        {
