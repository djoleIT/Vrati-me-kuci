...
const dict = {
  sr: {
    ...
    "sections": [
        ...
        },
        {
            ...
            "body": "Privezak trenutno košta {PROMO_PRICE} din (redovna cena {REGULAR_PRICE} din). Cena mogu biti izmenjena u budućnosti — cena koja važi je uvek ona prikazana na sajtu u trenutku narudžbine. Plaćanje je isključivo pouzećem: naplatu vrši kurirska služba prilikom uručenja pošiljke. Ne tražimo niti čuvamo podatke platnih kartica na sajtu."
        },
        {
    ...
    faqItems: [
      { id: "radi", q: "Da li ovo stvarno radi?", a: "Da. Svaki privezak ima svoj jedinstveni QR kod koji vodi na pravu, živu stranicu sa tvojim kontakt podacima. Skeniraj bilo koji QR kod telefonom da probaš." },
      { id: "cena", q: "Koliko košta i kako se plaća?", a: null },
      { id: "cip", q: "Da li je QR privezak bolji od čipovanja?", a: null },
      { id: "podaci", q: "Ko vidi moje podatke?", a: "Samo ono što ti sam izabereš da bude javno vidljivo posle skeniranja (npr. telefon). Kućnu adresu koristimo isključivo za slanje priveska i ona se nikad ne prikazuje javno, osim ako to eksplicitno ne uključiš." },
      { id: "izmena", q: "Mogu li kasnije da promenim broj telefona?", a: "Da, javi nam se na email ispod i ažuriraćemo profil — privezak i QR kod ostaju isti, menja se samo sadržaj iza njega." },
    ],
    faqContactPrefix: "Imaš drugo pitanje? Piši nam na",
    galleryOptionsTitle: "Dostupne opcije",
    galleryOptionsNote: "Biraš tip pričvršćivanja (alkica ili traka za navlačenje) i da li ime ljubimca stoji na privesku.",
    galleryRealTitle: "Kako izgleda u stvarnosti",
    galleryCaptions: {
      ringWithName: "Alkica — sa imenom",
      ringNoName: "Alkica — samo QR kod",
      strapWithName: "Traka za navlačenje — sa imenom",
      strapNoName: "Traka za navlačenje — samo QR kod",
      photo1: "Privezak na ogrlici",
      photo2: "Skeniranje QR koda",
      photo3: "Odštampan privezak",
    },
    ...
    attachmentTitle: "Tip pričvršćivanja",
    attachmentStrap: "Traka za navlačenje",
    attachmentStrapDesc: "Privezak ima dva proreza — traka ili deo ogrlice se provlači direktno kroz njega.",
    attachmentRing: "Privezak sa alkicom",
    attachmentRingDesc: "Klasičan privezak koji visi na maloj alkici — kačiš ga na D-prsten ogrlice.",
    nameOnTagTitle: "Prikaz na privesku",
    nameOnTagYes: "Sa imenom",
    nameOnTagYesDesc: "Ime ljubimca je fizički odštampano/urezano na privesku, pored QR koda.",
    nameOnTagNo: "Samo QR kod",
    nameOnTagNoDesc: "Minimalistički izgled — samo QR kod, bez teksta na privesku.",
  ...
  en: {
    ...
    faqItems: [
      { id: "radi", q: "Does this actually work?", a: "Yes. Every tag has its own unique QR code that leads to a real, live page with your contact info. Scan any QR code on this site with your phone to try it." },
      { id: "cena", q: "How much does it cost and how do I pay?", a: null },
      { id: "cip", q: "Is a QR tag better than microchipping?", a: null },
      { id: "podaci", q: "Who sees my data?", a: "Only what you choose to make publicly visible after scanning (e.g. your phone number). We use your home address solely to ship the tag, and it's never shown publicly unless you explicitly turn that on." },
      { id: "izmena", q: "Can I change my phone number later?", a: "Yes — email us below and we'll update your profile. The tag and QR code stay the same; only the content behind it changes." },
    ],
    faqContactPrefix: "Have another question? Write to us at",
    galleryOptionsTitle: "Available options",
    galleryOptionsNote: "Choose the attachment type (ring or slide-through strap) and whether your pet's name appears on the tag.",
    galleryRealTitle: "What it looks like in real life",
    galleryCaptions: {
      ringWithName: "Ring — with name",
      ringNoName: "Ring — QR code only",
      strapWithName: "Slide-through strap — with name",
      strapNoName: "Slide-through strap — QR code only",
      photo1: "Tag on a collar",
      photo2: "Scanning the QR code",
      photo3: "Printed tag",
    },
    ...
    attachmentTitle: "Attachment type",
    attachmentStrap: "Slide-through strap",
    attachmentStrapDesc: "The tag has two slots — the collar strap threads directly through it.",
    attachmentRing: "Pendant with ring",
    attachmentRingDesc: "A classic tag that hangs from a small ring — clip it onto your collar's D-ring.",
    nameOnTagTitle: "Tag display",
    nameOnTagYes: "With name",
    nameOnTagYesDesc: "The pet's name is physically printed/engraved on the tag, next to the QR code.",
    nameOnTagNo: "QR code only",
    nameOnTagNoDesc: "Minimalist look — just the QR code, no text on the tag.",
  ...
  ru: {
    ...
    faqItems: [
      { id: "radi", q: "Это правда работает?", a: "Да. У каждого брелока свой уникальный QR-код, ведущий на настоящую, живую страницу с вашими контактными данными. Отсканируйте любой QR-код на сайте телефоном, чтобы проверить." },
      { id: "cena", q: "Сколько это стоит и как оплатить?", a: null },
      { id: "cip", q: "QR-брелок лучше, чем чипирование?", a: null },
      { id: "podaci", q: "Кто видит мои данные?", a: "Только то, что вы сами разрешите показывать публично после сканирования (например, телефон). Домашний адрес используется исключительно для отправки брелока и никогда не показывается публично, если вы явно это не включите." },
      { id: "izmena", q: "Могу ли я потом изменить номер телефона?", a: "Да, напишите нам на email ниже, и мы обновим профиль — брелок и QR-код останутся теми же, изменится только содержимое за ним." },
    ],
    faqContactPrefix: "Есть другой вопрос? Напишите нам на",
    galleryOptionsTitle: "Доступные варианты",
    galleryOptionsNote: "Выберите тип крепления (кольцо или продеваемый ремешок) и нужно ли отображать кличку питомца на брелоке.",
    galleryRealTitle: "Как это выглядит в реальности",
    galleryCaptions: {
      ringWithName: "Кольцо — с кличкой",
      ringNoName: "Кольцо — только QR-код",
      strapWithName: "Продеваемый ремешок — с кличкой",
      strapNoName: "Продеваемый ремешок — только QR-код",
      photo1: "Брелок на ошейнике",
      photo2: "Сканирование QR-кода",
      photo3: "Напечатанный брелок",
    },
    ...
    attachmentTitle: "Тип крепления",
    attachmentStrap: "Продеваемый ремешок",
    attachmentStrapDesc: "У брелока два прорезя — ремешок ошейника продевается прямо через него.",
    attachmentRing: "Кулон с кольцом",
    attachmentRingDesc: "Классический брелок, который висит на маленьком кольце — крепится к D-кольцу ошейника.",
    nameOnTagTitle: "Оформление брелока",
    nameOnTagYes: "С кличкой",
    nameOnTagYesDesc: "Кличка питомца физически напечатана/выгравирована на брелоке рядом с QR-кодом.",
    nameOnTagNo: "Только QR-код",
    nameOnTagNoDesc: "Минималистичный вид — только QR-код, без текста на брелоке.",
  ...
  zh: {
    ...
    "sections": [
        ...
        {
            "title": "价格与付款",
            "body": "挂牌目前售价{PROMO_PRICE}第纳尔(原价{REGULAR_PRICE}第纳尔)。价格未来可能变动——以下单时网站显示的价格为准。仅支持货到付款:快递员在交付包裹时收取款项。我们绝不在网站上索取或存储银行卡信息。"
        },
        {
            "title": "个性化定制与撤销权",
    ...
    faqItems: [
      { id: "radi", q: "这真的有用吗?", a: "是的。每个挂牌都有独一无二的二维码,链接到包含您联系方式的真实在线页面。用手机扫描本站任意二维码即可试用。" },
      { id: "cena", q: "多少钱?怎么付款?", a: null },
      { id: "cip", q: "二维码挂牌比植入芯片更好吗?", a: null },
      { id: "podaci", q: "谁能看到我的数据?", a: "只有您选择公开的信息(例如电话号码)才会在扫描后显示。您的家庭住址仅用于寄送挂牌,除非您明确开启,否则绝不公开显示。" },
      { id: "izmena", q: "以后可以更改电话号码吗?", a: "可以——请通过下方邮箱联系我们,我们会更新您的档案。挂牌和二维码保持不变,只有背后的内容会更新。" },
    ],
    faqContactPrefix: "还有其他问题?请联系我们:",
    galleryOptionsTitle: "可选方案",
    galleryOptionsNote: "选择佩戴方式(圆环或穿孔式挂牌),以及挂牌上是否显示宠物姓名。",
    galleryRealTitle: "实物效果",
    galleryCaptions: {
      ringWithName: "圆环款 — 含姓名",
      ringNoName: "圆环款 — 仅二维码",
      strapWithName: "穿孔款 — 含姓名",
      strapNoName: "穿孔款 — 仅二维码",
      photo1: "项圈上的挂牌",
      photo2: "扫描二维码",
      photo3: "打印好的挂牌",
    },
    ...
    attachmentTitle: "佩戴方式",
    attachmentStrap: "穿孔式挂牌",
    attachmentStrapDesc: "挂牌有两个孔——项圈带可直接穿过。",
    attachmentRing: "带圆环挂坠",
    attachmentRingDesc: "经典挂牌,通过小圆环悬挂——扣在项圈的D形环上。",
    nameOnTagTitle: "挂牌显示内容",
    nameOnTagYes: "含姓名",
    nameOnTagYesDesc: "宠物姓名与二维码一起实际打印/雕刻在挂牌上。",
    nameOnTagNo: "仅二维码",
    nameOnTagNoDesc: "简约外观——挂牌上只有二维码,没有文字。",
  ...
  de: {
    ...
    "sections": [
        ...
        },
        {
            ...
            "body": "Die Marke kostet derzeit {PROMO_PRICE} Din. (regulärer Preis {REGULAR_PRICE} Din.). Preise können sich in Zukunft ändern — es gilt immer der auf der Website zum Zeitpunkt der Bestellung angezeigte Preis. Die Zahlung erfolgt ausschließlich per Nachnahme: Der Kurier kassiert bei Übergabe der Sendung. Wir fragen niemals Kartendaten ab und speichern sie nicht auf der Website."
        },
        {
    ...
    faqItems: [
      { id: "radi", q: "Funktioniert das wirklich?", a: "Ja. Jede Marke hat ihren eigenen einzigartigen QR-Code, der zu einer echten, live geschalteten Seite mit deinen Kontaktdaten führt. Scanne einen beliebigen QR-Code auf dieser Seite mit deinem Handy, um es auszuprobieren." },
      { id: "cena", q: "Was kostet es und wie bezahle ich?", a: null },
      { id: "cip", q: "Ist eine QR-Marke besser als ein Chip?", a: null },
      { id: "podaci", q: "Wer sieht meine Daten?", a: "Nur das, was du selbst nach dem Scannen öffentlich sichtbar machst (z. B. deine Telefonnummer). Deine Heimatadresse nutzen wir ausschließlich für den Versand der Marke und zeigen sie nie öffentlich, außer du aktivierst das ausdrücklich." },
      { id: "izmena", q: "Kann ich meine Telefonnummer später ändern?", a: "Ja — schreib uns unten per E-Mail und wir aktualisieren dein Profil. Marke und QR-Code bleiben gleich, nur der Inhalt dahinter ändert sich." },
    ],
    faqContactPrefix: "Noch eine Frage? Schreib uns an",
    galleryOptionsTitle: "Verfügbare Optionen",
    galleryOptionsNote: "Wähle die Befestigungsart (Ring oder Durchziehband) und ob der Name deines Haustiers auf der Marke steht.",
    galleryRealTitle: "So sieht es in echt aus",
    galleryCaptions: {
      ringWithName: "Ring — mit Namen",
      ringNoName: "Ring — nur QR-Code",
      strapWithName: "Durchziehband — mit Namen",
      strapNoName: "Durchziehband — nur QR-Code",
      photo1: "Marke am Halsband",
      photo2: "QR-Code scannen",
      photo3: "Gedruckte Marke",
    },
    ...
    attachmentTitle: "Befestigungsart",
    attachmentStrap: "Durchziehband",
    attachmentStrapDesc: "Die Marke hat zwei Schlitze — das Halsbandband wird direkt hindurchgefädelt.",
    attachmentRing: "Anhänger mit Ring",
    attachmentRingDesc: "Eine klassische Marke, die an einem kleinen Ring hängt — am D-Ring des Halsbands befestigt.",
    nameOnTagTitle: "Darstellung auf der Marke",
    nameOnTagYes: "Mit Namen",
    nameOnTagYesDesc: "Der Name des Haustiers wird zusammen mit dem QR-Code physisch gedruckt/graviert.",
    nameOnTagNo: "Nur QR-Code",
    nameOnTagNoDesc: "Minimalistischer Look — nur der QR-Code, kein Text auf der Marke.",
